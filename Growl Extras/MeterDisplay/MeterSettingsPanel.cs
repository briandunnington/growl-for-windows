...
namespace Meter
{
    public partial class MeterSettingsPanel : SettingsPanelBase
    {
        private static Point TOP_LEFT = new Point(19, 14);
        private static Point TOP_RIGHT = new Point(81, 14);
        private static Point BOTTOM_LEFT = new Point(17, 79);
        private static Point BOTTOM_RIGHT = new Point(82, 79);

        private Point overlayPosition = TOP_RIGHT;

        public MeterSettingsPanel()
        {
            InitializeComponent();
        }
        ...
        {
            this.computerScreenPictureBox.Image = Meter.Properties.Resources.my_computer;
        ...
        {
            e.Graphics.DrawImage(Meter.Properties.Resources.overlay, this.overlayPosition);
        }
        ...
        private Point GetLocation()
        {
            ...
            if (settings != null && settings.ContainsKey(MeterDisplay.SETTING_DISPLAYLOCATION))
            {
                try
                {
                    object val = settings[MeterDisplay.SETTING_DISPLAYLOCATION];
        ...
        private void SaveLocation()
        {
            ...
            this.SaveSetting(MeterDisplay.SETTING_DISPLAYLOCATION, i);
        }

...
{
    public partial class IphoneSettingsPanel : SettingsPanelBase
    {
        ...
        {
            this.computerScreenPictureBox.Image = global::IphoneStyle.Properties.Resources.My_Computer;
        ...
        {
            e.Graphics.DrawImage(global::IphoneStyle.Properties.Resources.overlay, this.overlayPosition);
        }
        ...
        private Point GetLocation()
        {
            ...
            if (settings != null && settings.ContainsKey(IphoneDisplay.SETTING_DISPLAYLOCATION))
            {
                try
                {
                    object val = settings[IphoneDisplay.SETTING_DISPLAYLOCATION];
        ...
        private void SaveLocation()
        {
            ...
            this.SaveSetting(IphoneDisplay.SETTING_DISPLAYLOCATION, i);
        }

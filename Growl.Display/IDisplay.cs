...
namespace Growl.DisplayStyle
{
    ...
    /// </summary>
    /// <remarks>
    /// Most developers should simply inherit from the <see cref="Display"/> class, 
    /// which provides implementations for most common properties. If you choose
    /// to implement <see cref="IDisplay"/> directly, note that your display class must still
    /// inherit from <see cref="MarshalByRefObject"/>.
    /// </remarks>
    public interface IDisplay
    {
        ...
        void HandleNotification(Notification notification, string displayName);

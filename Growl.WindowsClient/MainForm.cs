...
namespace Growl.WindowsClient
{
    public partial class MainForm : Form
    {
        ...
        internal void ExitApp()
        {
            ...
            {
                Growl.DisplayStyle.SettingsPanelBase sp = (Growl.DisplayStyle.SettingsPanelBase)this.displaySettingsPanel.Tag;
                sp.DeselectPanel();
            }
        ...
        private void displayOptionsListBox_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            if (this.displayOptionsContainerPanel.Tag != null && this.displayOptionsContainerPanel.Tag is Growl.DisplayStyle.SettingsPanelBase)
            {
                Growl.DisplayStyle.SettingsPanelBase sp = (Growl.DisplayStyle.SettingsPanelBase)this.displayOptionsContainerPanel.Tag;
                sp.DeselectPanel();
            }

...
namespace Growl.Daemon
{
    ...
    public class MutableData : Data
    {
        ...
        public MutableData(byte[] buffer)
            : base(buffer, false)
        {
            // Nothing to do here
        }

        public MutableData(byte[] buffer, bool copy)
            : base(buffer, copy)
        {
            // Nothing to do here
        }

        public MutableData(byte[] buffer, int offset, int length)
        ...
        public MutableData(String str)
            : base(str, Encoding.UTF8)
        {
            // Nothing to do here
        }

        public MutableData(String str, Encoding enc)
            : base(str, enc)
        {
            // Nothing to do here
        }

...
namespace Vortex.Growl.AppBridge
{
    ...
    public class Display : DefaultablePreference, ISerializable
    {
        ...
        private Vortex.Growl.DisplayStyle.IDisplay display;
        ...
        public Display(string name, Vortex.Growl.DisplayStyle.IDisplay display) : this(name, display, false)
        {
        }

        private Display(string name, Vortex.Growl.DisplayStyle.IDisplay display, bool isDefault)
        {
            this.name = name;
        ...
        public Vortex.Growl.DisplayStyle.SettingsPanelBase SettingsPanel
        {
            get
            {
